...
test("renders a self-contained 1200 by 630 PNG", () => {
  const dir = mkdtempSync(join(tmpdir(), "pacvamp-social-"));
  try {
...
test("built-page checks use the homepage title and reject swapped images and empty alt text", () => {
  ...
  const page = (title, card, alt = title + " — pacvamp docs") => `
    <meta property="og:title" content="${title} | pacvamp">
    <meta name="twitter:title" content="${title} | pacvamp">

...
## [0.2.1](https://github.com/jdx/pacvamp/compare/v0.2.0..v0.2.1) - 2026-09-17
...
- add entire trail runners in [#93](https://github.com/jdx/pacvamp/pull/93)
...
- reorganize guides and redesign the documentation site in [#87](https://github.com/jdx/pacvamp/pull/87)
- write PR titles and descriptions for release notes in [#89](https://github.com/jdx/pacvamp/pull/89)
...
- **cli:** publish native completions in packslip in [#85](https://github.com/jdx/pacvamp/pull/85)
...
- **deps:** bump mr-boxington to 1.8.3 in [#86](https://github.com/jdx/pacvamp/pull/86)
- add zizmor GitHub Actions audit in [#88](https://github.com/jdx/pacvamp/pull/88)
- replace actionlint with zizmor in [#90](https://github.com/jdx/pacvamp/pull/90)
